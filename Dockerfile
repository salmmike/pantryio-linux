...
RUN apt-get update && apt-get install -y gawk wget git-core git diffstat unzip texinfo gcc build-essential \
                               ...
                               gcc-multilib libgmp-dev libmpc-dev libssl-dev repo openssh-client \
                               g++-multilib tmux
